...
public class FileRepositoryImpl implements  FileRepositoryCustom{
    ...
    public Pair<Long, List<File>> getInTrashByFilter(FileFilterInput input) {
        ...
        whereConditions.add(cb.or(cb.isTrue(fileRoot.get(File_.IN_TRASH)),cb.isTrue(fJoinFileActivity.get(FileActivity_.IN_TRASH)),cb.isTrue(fJoinFileActivityTask.get(FileTask_.IN_TRASH))));
